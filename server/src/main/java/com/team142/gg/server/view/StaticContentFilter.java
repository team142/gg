...
public class StaticContentFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("StaticContentFilter:DoBeforeProcessing");
        }
...
//        Logger.getLogger(this.getClass().getName()).log(Level.INFO, r.getRequestURL().toString());
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("StaticContentFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("StaticContentFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("StaticContentFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("StaticContentFilter()");
        }
        StringBuffer sb = new StringBuffer("StaticContentFilter(");
