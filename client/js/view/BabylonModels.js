...
export class BabylonModels {
    ...
    static loadBaseFlatTile() {
        ...
        baby.baseTile.position.z = y
        baby.baseTile.position.x = x
    ...
    static loadBaseMountainTile() {
        ...
        baby.mountainTile = BABYLON.MeshBuilder.CreateBox(("plane" + x) + y, {
            height: 1,
            width: 1,
            depth: 1
        }, baby.scene)
        baby.mountainTile.position.z = y
        baby.mountainTile.position.x = x
